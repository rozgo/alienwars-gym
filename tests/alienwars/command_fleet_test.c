...
int main(void){
    ...
    puts("COMMAND_FLEET valid_goal=PASS preserve_pose_momentum=PASS rejected_goal_retains_mission=PASS pause=PASS equipment_changes_observation=PASS map_unchanged=PASS");
}
